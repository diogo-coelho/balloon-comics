        ...
        <section className="age-verification-section">
          ...
          <div className="age-verification-segment">
            <p className="paragraph-segment">
              <strong>Atenção:</strong> O preenchimento desse campo é
              obrigatório para acessar qualquer conteúdo dentro da Balloon
              Comics marcado com classificação indicativa 18+.
            </p>
