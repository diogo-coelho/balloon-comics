...
export class CreateTables1788391903292 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."authors_status_enum" AS ENUM('ACTIVE', 'INACTIVE', 'BANNED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "processed_events" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "event_id" uuid NOT NULL, "consumer" character varying(100) NOT NULL, "processed_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a08d68aa0747daea9efd2ddea53" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "uq_processed_event_consumer" ON "processed_events"  ("event_id", "consumer") `,
    );
    await queryRunner.query(
      `ALTER TABLE "authors" ADD CONSTRAINT "FK_5064b1842d13bd17251cfbce7f6" FOREIGN KEY ("reader_id") REFERENCES "readers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "social_media_links" ADD CONSTRAINT "FK_bbab910fcfb70961a38e059d09b" FOREIGN KEY ("reader_id") REFERENCES "readers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "age_verifications" ADD CONSTRAINT "FK_3d90a369e8451c11d3b7235eb2e" FOREIGN KEY ("reader_id") REFERENCES "readers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "age_verifications" DROP CONSTRAINT "FK_3d90a369e8451c11d3b7235eb2e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "social_media_links" DROP CONSTRAINT "FK_bbab910fcfb70961a38e059d09b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "authors" DROP CONSTRAINT "FK_5064b1842d13bd17251cfbce7f6"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."uq_processed_event_consumer"`,
    );
