...
@Module({
  ...
  providers: [
    ...
    },
    {
      ...
      inject: [PROVIDERS_TOKENS.CORE_UNIT_OF_WORK],
      useFactory: (unitOfWork: CoreUnitOfWorkPort) =>
        new CreateReaderFromUserEventUseCase(unitOfWork),
    },
    {
      provide: UpdateReaderFromUserEventUseCase,
      inject: [PROVIDERS_TOKENS.CORE_UNIT_OF_WORK],
      useFactory: (unitOfWork: CoreUnitOfWorkPort) =>
        new UpdateReaderFromUserEventUseCase(unitOfWork),
    },
    {
      provide: DeleteReaderFromUserEventUseCase,
      inject: [PROVIDERS_TOKENS.CORE_UNIT_OF_WORK],
      useFactory: (unitOfWork: CoreUnitOfWorkPort) =>
        new DeleteReaderFromUserEventUseCase(unitOfWork),
    },
    {
      ...
      useFactory: (
        ...
        storage: StoragePort,
      ) => new UploadReaderImageUseCase(readers, imageProcessor, storage),
    },
    {
      provide: UpdateReaderUseCase,
      inject: [PROVIDERS_TOKENS.CORE_UNIT_OF_WORK, PROVIDERS_TOKENS.STORAGE],
      useFactory: (unitOfWork: CoreUnitOfWorkPort, storage: StoragePort) =>
        new UpdateReaderUseCase(unitOfWork, storage),
    },
    RabbitMqRetryProvider,
    AuthTokenGuard,
  ],
  exports: [PROVIDERS_TOKENS.CORE_UNIT_OF_WORK],
})
