...
export class SocialMediaLinkService {
  ...
  async getSocialMediaLinksByReaderId(
    ...
    return socialMediaLinks.map((link) =>
      this.socialMediaLinkMapper.toModelFromEntity(link, false),
    );
  }

  async getSocialMediaLinkByReaderIdAndName(
    reader: ReaderEntity,
    name: string,
  ): Promise<any> {
    ...
    return socialMediaLinks
      ? this.socialMediaLinkMapper.toModelFromEntity(socialMediaLinks, false)
      : null;
  }
  ...
  async createSocialMediaLink(
    ...
    const savedSocialMediaLink =
      await this.socialMediaLinkRepository.save(socialMediaLink);

    return this.socialMediaLinkMapper.toModelFromEntity(
      savedSocialMediaLink,
      false,
    );
  }
}
